...
def animate_3d(i):
    ...
    for anchor in anchors:
        ...
        if is_alive:
            point_color = family_colors[int(family_id)]
            ax_3d.scatter(x, y, z, s=s_anchor_3d, color="black")
...
def launch(scene_name, 
    ...
    create_gif(log_path_agents, log_path_anchors, gif_path_3d, flag="3d", frame_step=20)
...
launch(scene_name, 5, 6, anchor_mode="predefined", dt=0.02, log_step=1, n_iters=60000, u_max=3.0, sigma=0.6)